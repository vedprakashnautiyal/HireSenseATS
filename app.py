...
Dataset = pd.read_csv('innov8/df_resume_sorted.csv')
...
available_tags = ['Accounting', 'administrative', 'budgets', 'documentation', 'financial', 'coaching', 'Excel', 'hardware', 'delivery', 'banking', 'inventory']
    ...
    if not st.session_state.view_profile:
        ...
        # Display profile view based on current_profile_id
            ...
            if st.session_state.view_profile:
                    ...
                    text_data = pd.read_csv('innov8/resume_text.csv')
                    ...
                    from langchain_google_genai import ChatChatGoogleGenerativeAI
                    from langchain.prompts import PromptTemplate

                    # Get Groq API key
                    GEMINI_API_KEY = os.getenv("KEY")  # Replace 'your_api' with your actual API key
